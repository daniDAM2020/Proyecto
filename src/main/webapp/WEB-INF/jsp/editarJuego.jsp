											...
											<table>
												...
												<form:form modelAttribute="juego" method="post">
         										...
         										<form:input class="form-control" style="font-size: 20px" type="text" path="precio" required="true"  />
          										...
          										<form:select id="desarrolladora" class="form-control" path="desarrolladora">
														<c:forEach items="${listadoDesarrolladoras}" var="item">
															<form:option value="${item.id_desarrolladora}" class="form-control">${item.nombre}</form:option>
          										...
          										<form:select id="consola" class="form-control" path="consola">
         											...
         											<form:input type="text" class="form-control" style="font-size: 20px" path="foto" required="true" />
														...
														<h3><a href="http://localhost:8080/listadoJuegos"><input class="button2 form-control"  type="text" value="Volver" style="font-size: 20px;text-align:center"  /></a></h3></br>
