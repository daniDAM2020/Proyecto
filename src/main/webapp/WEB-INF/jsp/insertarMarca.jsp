						...
						<div class="wrapper">
							...
							<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
								<h3 class="heading-tittle text-center font-italic">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pulsa
									el boton para insertar</h3></br>
								<div class="row">
									<div class="col-md-12 product-men pt-1">
										<div class="men-pro-item simpleCart_shelfItem">
											<div class="men-thumb-item text-center"></div>
											<table>
												<form:form modelAttribute="marca" style="font-size: 20px" method="POST">
        												 <h3>Nombre:</h3>
         												...
         												<h3>Foto:</h3>
         												<form:input type="text"  required="true" class="form-control" path="foto" style="font-size: 20px"/></br>

														<h3><input class="button2 form-control"  type="submit" value="Insertar" style="font-size: 20px" /></h3></br>

														<h3><a href="listadoMarcas"><input class="button2 form-control"  type="text" value="Volver" style="font-size: 20px;text-align:center"  /></a></h3></br>
